...
urlpatterns = [
    ...
    path("payment/create/", PaymentCreateAPIView.as_view(permission_classes=[permissions.IsAuthenticated]),
         name="payment_create"),
    ...
    path("user/<int:pk>/update/", UserUpdateAPIView.as_view(permission_classes=[permissions.IsAuthenticated, IsOwner]),
         name="user_update")
]
